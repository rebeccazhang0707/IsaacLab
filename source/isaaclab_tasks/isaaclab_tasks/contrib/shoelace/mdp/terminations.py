...
from .grasp import _filter_grasps, shoelace_grasp_quality
...
def shoelace_success(
    ...
    This geometry-only helper combines throat clearance with tail distance and X separation.
...
class shoelace_bilateral_pull_success(ManagerTermBase):
    ...
    def __call__(
        ...
        filtered = _filter_grasps(self._filtered_grasp, grasp, finite, env.step_dt, grasp_filter_time_constant)
