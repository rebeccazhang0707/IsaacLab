...
_LEFT_FRANKA_CURRICULUM_JOINT_POSITIONS = (_LEFT_FRANKA_SETTLED_GRASP_JOINT_POSITIONS,) * 9 + (
...
_RIGHT_FRANKA_CURRICULUM_JOINT_POSITIONS = (_RIGHT_FRANKA_SETTLED_GRASP_JOINT_POSITIONS,) * 9 + (
...
_CURRICULUM_GRIPPER_JOINT_POSITIONS = (
    tuple(
        ...
        for fraction in (0.0, 0.0625, 0.125, 0.1875, 0.25, 0.375, 0.5, 0.75, 1.0)
    )
