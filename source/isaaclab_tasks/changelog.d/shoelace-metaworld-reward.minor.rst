...
* Synchronized the shoelace anchors, seam-local collision meshes, tongue collider, and Newton solver and contact
  capacities with the validated standalone demo.
