...
class BaseArticulation(AssetBase):
    ...
    def __init__(self, cfg: ArticulationCfg):
        ...
        # assigned_envs is a tuple of global environment indices that the articulation instance should manage
    ...
    def assigned_envs(self) -> tuple[int, ...]:
        """Global environment indices handled by this articulation instance."""
