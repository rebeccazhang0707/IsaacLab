...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.demo_multi_robot_lift_env_cfg:MultiRobotLiftEnvCfg",
        "rsl_rl_cfg_entry_point": f"{__name__}.agents.rsl_rl_ppo_cfg:MultiRobotLiftPPORunnerCfg",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.demo_multi_robot_lift_env_cfg:MultiRobotLiftEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{__name__}.agents.rsl_rl_ppo_cfg:MultiRobotLiftPPORunnerCfg",
    },
    disable_env_checker=True,
)
